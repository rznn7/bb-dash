...
impl ApiPullrequestTask {
    pub fn new(created_on: String, updated_on: String, state: State, content: serde_json::Value, creator: models::ApiAccount) -> ApiPullrequestTask {
        ApiPullrequestTask {
            id: None,
            created_on,
            updated_on,
