...
**rendered** | Option<[**serde_json::Value**](.md)> | User provided pull request text, interpreted in a markup language and rendered in HTML | [optional]
**summary** | Option<[**serde_json::Value**](.md)> |  | [optional]
**state** | Option<**String**> | The pull request's current status. | [optional]
**author** | Option<[**models::Account**](account.md)> |  | [optional]
**source** | Option<[**models::PullrequestEndpoint**](pullrequest_endpoint.md)> |  | [optional]
**destination** | Option<[**models::PullrequestEndpoint**](pullrequest_endpoint.md)> |  | [optional]
**merge_commit** | Option<[**serde_json::Value**](.md)> |  | [optional]
