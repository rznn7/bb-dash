...
pub struct ApiPullrequestComment {
    #[serde(rename = "type")]
    pub r#type: String,
    ...
    pub parent: Option<Box<models::ApiComment>>,
    ...
    pub pullrequest: Option<Box<models::ApiPullrequest>>,
    #[serde(rename = "resolution", skip_serializing_if = "Option::is_none")]
    pub resolution: Option<models::ApiCommentResolution>,
    #[serde(rename = "pending", skip_serializing_if = "Option::is_none")]
    pub pending: Option<bool>,
}

impl ApiPullrequestComment {
    pub fn new(r#type: String) -> ApiPullrequestComment {
