...
**uuid** | Option<**String**> | The commit status' id. | [optional]
**key** | Option<**String**> | An identifier for the status that's unique to         its type (current \"build\" is the only supported type) and the vendor,         e.g. BB-DEPLOY | [optional]
...
**state** | Option<**State**> | Provides some indication of the status of this commit (enum: FAILED, INPROGRESS, STOPPED, SUCCESSFUL) | [optional]
