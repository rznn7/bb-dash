...
pub struct ApiPipeline {
    ...
    pub target: Option<Box<models::ApiPipelineTarget>>,
    #[serde(rename = "trigger", skip_serializing_if = "Option::is_none")]
    pub trigger: Option<Box<models::ApiPipelineTrigger>>,
    #[serde(rename = "state", skip_serializing_if = "Option::is_none")]
    pub state: Option<Box<models::ApiPipelineState>>,
    /// The variables for the pipeline.
    #[serde(rename = "variables", skip_serializing_if = "Option::is_none")]
    pub variables: Option<Vec<models::ApiPipelineVariable>>,
    ...
    pub configuration_sources: Option<Vec<models::ApiPipelineConfigurationSource>>,
    #[serde(rename = "links", skip_serializing_if = "Option::is_none")]
    pub links: Option<Box<models::ApiPipelinesPipelineLinks>>,
}

impl ApiPipeline {
    pub fn new(r#type: String) -> ApiPipeline {
        ApiPipeline {
            r#type,
            uuid: None,
            build_number: None,
