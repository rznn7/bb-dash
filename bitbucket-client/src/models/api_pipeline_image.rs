...
/// ApiPipelineImage : The definition of a Docker image that can be used for a Bitbucket Pipelines step execution context.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ApiPipelineImage {
