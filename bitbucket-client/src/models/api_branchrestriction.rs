...
pub struct ApiBranchrestriction {
    #[serde(rename = "type")]
    pub r#type: String,
    ...
    pub users: Option<Vec<models::ApiAccount>>,
    #[serde(rename = "groups", skip_serializing_if = "Option::is_none")]
    pub groups: Option<Vec<models::ApiGroup>>,
}

impl ApiBranchrestriction {
    pub fn new(r#type: String, kind: Kind, branch_match_kind: BranchMatchKind, pattern: String) -> ApiBranchrestriction {
