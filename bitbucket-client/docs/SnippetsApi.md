...
> models::Snippet snippets_post(_body)
Create a snippet
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**_body** | [**Snippet**](Snippet.md) | The new snippet object. | [required] |
...
> models::SnippetComment snippets_workspace_encoded_id_comments_comment_id_put(comment_id, encoded_id, workspace, _body)
...
**encoded_id** | **String** | The snippet id. | [required] |
**workspace** | **String** | This can either be the workspace ID (slug) or the workspace UUID surrounded by curly-braces, for example: `{workspace UUID}`.  | [required] |
**_body** | [**SnippetComment**](SnippetComment.md) | The contents to update the comment to. | [required] |
...
> models::SnippetComment snippets_workspace_encoded_id_comments_post(encoded_id, workspace, _body)
...
**encoded_id** | **String** | The snippet id. | [required] |
**workspace** | **String** | This can either be the workspace ID (slug) or the workspace UUID surrounded by curly-braces, for example: `{workspace UUID}`.  | [required] |
**_body** | [**SnippetComment**](SnippetComment.md) | The contents of the new comment. | [required] |
...
> models::Snippet snippets_workspace_post(workspace, _body)
