...
**subject_type** | Option<**String**> | The type of entity. Set to either `repository` or `workspace` based on where the subscription is defined. | [optional]
**subject** | Option<[**models::Object**](serde_json::Value.md)> |  | [optional]
**active** | Option<**bool**> |  | [optional]
**created_at** | Option<**String**> |  | [optional]
**events** | Option<**Vec<String>**> | The events this webhook is subscribed to. | [optional]
