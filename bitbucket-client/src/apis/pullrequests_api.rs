...
pub async fn repositories_workspace_repo_slug_pullrequests_get(configuration: &configuration::Configuration, repo_slug: &str, workspace: &str, state: Option<&str>, q: Option<&str>, pagelen: Option<i32>) -> Result<models::ApiPaginatedPullrequests, Error<RepositoriesWorkspaceRepoSlugPullrequestsGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_repo_slug = repo_slug;
    let p_path_workspace = workspace;
