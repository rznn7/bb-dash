# ApiPaginatedPipelineScheduleExecutions
...
**values** | Option<[**Vec<models::ApiPipelineScheduleExecution>**](PipelineScheduleExecution.md)> | The values of the current page. | [optional]
