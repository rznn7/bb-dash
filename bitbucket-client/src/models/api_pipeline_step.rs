...
pub struct ApiPipelineStep {
    ...
    pub state: Option<Box<models::ApiPipelineStepState>>,
    #[serde(rename = "image", skip_serializing_if = "Option::is_none")]
    pub image: Option<Box<models::ApiPipelineImage>>,
    ...
    pub setup_commands: Option<Vec<models::ApiPipelineCommand>>,
    ...
    pub script_commands: Option<Vec<models::ApiPipelineCommand>>,
}

impl ApiPipelineStep {
    pub fn new(r#type: String) -> ApiPipelineStep {
        ApiPipelineStep {
            r#type,
            uuid: None,
            started_on: None,
