...
/// ApiPullrequestMergeParameters : The metadata that describes a pull request merge.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ApiPullrequestMergeParameters {
    #[serde(rename = "type")]
    pub r#type: String,
...
impl ApiPullrequestMergeParameters {
    /// The metadata that describes a pull request merge.
    pub fn new(r#type: String) -> ApiPullrequestMergeParameters {
